    ...
    <>
            ...
            <div className=' absolute bottom-2 left-2 right-2  '>
              <div className='flex flex-col gap-2'>
                <div className='flex items-center justify-between'>
                  ...
                  <span className="bg-zinc-100/85 shadow text-zinc-500 font-bold uppercase px-3 py-1 w-fit rounded-full text-xs">{category}</span>
                </div>
      ...
      {featured == false &&
        <div className="relative min-w-64 cursor-pointer hover:transition-all flex flex-col bg-zinc-50 rounded-lg ring-1 ring-zinc-200 hover:ring-8 hover:ring-zinc-100 hover:ring-offset-1 hover:ring-offset-zinc-300 overflow-hidden">
          <div className="relative h-2/3 border-b border-zinc-200 overflow-hidden" >
            <Image
            ...
            <div className='absolute bottom-2 left-2 right-2 flex items-center  justify-end'>
              <span className="shadow bg-zinc-100/85 text-zinc-500 font-bold uppercase px-3 py-1 rounded-full text-xs">{category}</span>
            </div>
          </div>
          <div className="h-1/3 p-2 bg-white">
            <span className="text-xl text-zinc-900 leading-snug font-bold tracking-wide line-clamp-2">{title}</span>
